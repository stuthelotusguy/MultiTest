...
var RoomObject = {
    ...
    name: 'Mainscreen'
        ...
        room.state.players.onAdd(function (player, sessionId) {
            ...
            dom.addEventListener('mousedown', RoomObject.mouseDown, false);
            window.addEventListener('mouseup', RoomObject.mouseUp, false);
        });
    ...
    mouseUp : function () {
        window.removeEventListener('mousemove', RoomObject.move, true);
    },

    mouseDown : function (e) {
        window.addEventListener('mousemove', RoomObject.move, true);
    },
