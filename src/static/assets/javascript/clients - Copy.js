...
function update() {
    ...
    if (Gameroom !== null) {
        if (joystick1.value.y === 0) {
            ...
            /* To allow analog I will reset these: */
            inputs.inputUp = 0;
            inputs.inputDown = 0;
            inputs.inputLeft = 0;
            inputs.inputRight = 0;
            ...
            if (joystick1.value.y < -deadzone) {
                if (inputs.inputUp === 0) {
                    inputs.inputUp = 1
                    Gameroom.send("move", {
                        inputUp: -joystick1.value.y + deadzone
                    })
                    inputs.inputDown = 1;
                }
                if (inputs.inputDown === 1) {
                ...
                if (inputs.inputDown === 0) {
                    inputs.inputDown = 1
                    Gameroom.send("move", {
                        inputDown: joystick1.value.y - deadzone
                    })
                    inputs.inputUp = 1;
                }
                if (inputs.inputUp === 1) {
            ...
            if (joystick1.value.x === 0) {
                ...
                if (joystick1.value.x < -deadzone) {
                    if (inputs.inputLeft === 0) {
                        inputs.inputLeft = 1
                        Gameroom.send("move", {
                            inputLeft: -joystick1.value.x + deadzone
                        })
                        inputs.inputRight = 1;
                    }
                    if (inputs.inputRight === 1) {
                    ...
                    if (inputs.inputRight === 0) {
                        inputs.inputRight = 1
                        Gameroom.send("move", {
                            inputRight: joystick1.value.x - deadzone
                        })
                        inputs.inputLeft = 1;
                    }
                    if (inputs.inputLeft === 1) {
